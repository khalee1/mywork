<div class="container">
    ...
    <div>
        ...
        <form action="<?php echo URL; ?>works/edit" method="POST">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input autofocus type="text" name="work_name"
                                       value="<?php echo htmlspecialchars($work->work_name, ENT_QUOTES, 'UTF-8'); ?>"
                                       required/>
            ...
            <input type="hidden" name="id_work" value="<?php echo htmlspecialchars($work->id, ENT_QUOTES, 'UTF-8'); ?>"
                   required/>
            <div class="row">
                <div class="col-sm-8">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group date" id="startdate">
                                <input type="text" name="start_date"
                                       value="<?php echo htmlspecialchars($work->start_date, ENT_QUOTES, 'UTF-8'); ?>"
                                       class="form-control"/>
                        ...
                        <div class="col-sm-5">
                            <div class="input-group date" id="enddate">
                                <input type="text" name="end_date"
                                       value="<?php echo htmlspecialchars($work->end_date, ENT_QUOTES, 'UTF-8'); ?>"
                                       class="form-control"/>
                                <span class="input-group-addon">
                                    <span class="glyphicon-calendar glyphicon"></span>
                                </span>
